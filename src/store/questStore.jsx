...
import { useLeaderboardStore } from './localLeaderboardStore'
...
const syncLeaderboardState = (state) => {
  try {
    ...
    store
      ...
      .catch((error) => {
        console.warn('Failed syncing leaderboard entry', error)
      })
  } catch (error) {
